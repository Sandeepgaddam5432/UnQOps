      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-unqops-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-unqops-elements-item-backgroundAccent hover:bg-unqops-elements-artifacts-backgroundHover"
