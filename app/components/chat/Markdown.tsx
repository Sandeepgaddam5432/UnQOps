      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__boltSelectedElement__')) {
            ...
            return (
              <div className="bg-unqops-elements-background-depth-3 border border-unqops-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-unqops-elements-background-depth-2 px-2 py-1 rounded text-unqops-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-unqops-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-unqops-elements-textSecondary !bg-unqops-elements-background-depth-2 border border-unqops-elements-borderColor p-2 rounded">
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-unqops-elements-item-backgroundAccent text-unqops-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
