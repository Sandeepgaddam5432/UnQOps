  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-unqops-elements-borderColor bg-unqops-elements-background-depth-1 text-unqops-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-unqops-elements-textSecondary', className)} {...props} />;
  },
);
