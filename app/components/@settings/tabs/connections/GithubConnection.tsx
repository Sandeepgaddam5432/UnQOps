...
export default function GitHubConnection() {
  ...
  return (
    <motion.div
      className="bg-unqops-elements-background dark:bg-unqops-elements-background border border-unqops-elements-borderColor dark:border-unqops-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GithubLogo />
            <h3 className="text-base font-medium text-unqops-elements-textPrimary dark:text-unqops-elements-textPrimary">
              GitHub Connection
            </h3>
          </div>
        </div>
        ...
        {!connection.user && (
          <div className="text-xs text-unqops-elements-textSecondary bg-unqops-elements-background-depth-1 dark:bg-unqops-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-unqops-elements-icon-success dark:text-unqops-elements-icon-success" />
              <span className="font-medium">Tip:</span> You can also set the{' '}
              <code className="px-1 py-0.5 bg-unqops-elements-background-depth-2 dark:bg-unqops-elements-background-depth-2 rounded">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-unqops-elements-textSecondary dark:text-unqops-elements-textSecondary mb-2">
              Token Type
            </label>
            <select
              ...
              className={classNames(
                ...
                'bg-unqops-elements-background-depth-1 dark:bg-unqops-elements-background-depth-1',
                'border border-unqops-elements-borderColor dark:border-unqops-elements-borderColor',
                'text-unqops-elements-textPrimary dark:text-unqops-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-unqops-elements-item-contentAccent dark:focus:ring-unqops-elements-item-contentAccent',
                'disabled:opacity-50',
              )}
            >
          ...
          <div>
            ...
            <input
              ...
              className={classNames(
                ...
                'text-unqops-elements-textPrimary placeholder-unqops-elements-textTertiary',
                'focus:outline-none focus:ring-1 focus:ring-unqops-elements-borderColorActive',
                'disabled:opacity-50',
              )}
            />
            <div className="mt-2 text-sm text-unqops-elements-textSecondary">
              <a
                href={`https://github.com/settings/tokens${connection.tokenType === 'fine-grained' ? '/beta' : '/new'}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-unqops-elements-borderColorActive hover:underline inline-flex items-center gap-1"
              >
                Get your token
            ...
            <>
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-unqops-elements-textSecondary flex items-center gap-1">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="flex items-center gap-2 hover:bg-unqops-elements-item-backgroundActive/10 hover:text-unqops-elements-textPrimary dark:hover:text-unqops-elements-textPrimary transition-colors"
                  >
        ...
        {connection.user && connection.stats && (
          <div className="mt-6 border-t border-unqops-elements-borderColor dark:border-unqops-elements-borderColor pt-6">
            <div className="flex items-center gap-4 p-4 bg-unqops-elements-background-depth-1 dark:bg-unqops-elements-background-depth-1 rounded-lg mb-4">
              <img
                src={connection.user.avatar_url}
                alt={connection.user.login}
                className="w-12 h-12 rounded-full border-2 border-unqops-elements-item-contentAccent dark:border-unqops-elements-item-contentAccent"
              />
              <div>
                <h4 className="text-sm font-medium text-unqops-elements-textPrimary dark:text-unqops-elements-textPrimary">
                  {connection.user.name || connection.user.login}
                </h4>
                <p className="text-sm text-unqops-elements-textSecondary dark:text-unqops-elements-textSecondary">
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-unqops-elements-background dark:bg-unqops-elements-background-depth-2 border border-unqops-elements-borderColor dark:border-unqops-elements-borderColor hover:border-unqops-elements-borderColorActive/70 dark:hover:border-unqops-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:chart-bar w-4 h-4 text-unqops-elements-item-contentAccent" />
                    <span className="text-sm font-medium text-unqops-elements-textPrimary">GitHub Stats</span>
                  </div>
                  <div
                    className={classNames(
                      'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-unqops-elements-textSecondary',
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-unqops-elements-textPrimary mb-3">Top Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(connection.stats.languages)
                        ...
                        .map(([language]) => (
                          <span
                            key={language}
                            className="px-3 py-1 text-xs rounded-full bg-unqops-elements-sidebar-buttonBackgroundDefault text-unqops-elements-sidebar-buttonText"
                          >
                            {language}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex flex-col p-3 rounded-lg bg-unqops-elements-background-depth-2 dark:bg-unqops-elements-background-depth-2 border border-unqops-elements-borderColor dark:border-unqops-elements-borderColor"
                      >
                        <span className="text-xs text-unqops-elements-textSecondary">{stat.label}</span>
                        <span className="text-lg font-medium text-unqops-elements-textPrimary">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium text-unqops-elements-textPrimary mb-2">Repository Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-unqops-elements-textPrimary mb-2">Contribution Stats</h5>
                          ...
                          {[
                            {
                              ...
                              icon: 'i-ph:star',
                              iconColor: 'text-unqops-elements-icon-warning',
                            },
                            {
                              label: 'Forks',
                              value: connection.stats.forks || 0,
                              icon: 'i-ph:git-fork',
                              iconColor: 'text-unqops-elements-icon-info',
                            },
                            {
                              label: 'Followers',
                              value: connection.stats.followers || 0,
                              icon: 'i-ph:users',
                              iconColor: 'text-unqops-elements-icon-success',
                            },
                          ].map((stat, index) => (
                            <div
                              key={index}
                            ...
                            >
                              <span className="text-xs text-unqops-elements-textSecondary">{stat.label}</span>
                              <span className="text-lg font-medium text-unqops-elements-textPrimary flex items-center gap-1">
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-unqops-elements-textPrimary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                      ...
                      <div className="pt-2 border-t border-unqops-elements-borderColor">
                        <span className="text-xs text-unqops-elements-textSecondary">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-unqops-elements-textPrimary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-4 rounded-lg bg-unqops-elements-background-depth-1 dark:bg-unqops-elements-background-depth-1 border border-unqops-elements-borderColor dark:border-unqops-elements-borderColor hover:border-unqops-elements-borderColorActive dark:hover:border-unqops-elements-borderColorActive transition-all duration-200"
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-branch w-4 h-4 text-unqops-elements-icon-tertiary" />
                                <h5 className="text-sm font-medium text-unqops-elements-textPrimary group-hover:text-unqops-elements-item-contentAccent transition-colors">
                                  {repo.name}
                                </h5>
                              </div>
                              <div className="flex items-center gap-3 text-xs text-unqops-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <div className="i-ph:star w-3.5 h-3.5 text-unqops-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <div className="i-ph:git-fork w-3.5 h-3.5 text-unqops-elements-icon-info" />
                            ...
                            {repo.description && (
                              <p className="text-xs text-unqops-elements-textSecondary line-clamp-2">
                                {repo.description}
                              </p>
                            )}
                            ...
                            <div className="flex items-center gap-3 text-xs text-unqops-elements-textSecondary">
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-unqops-elements-item-contentAccent transition-colors">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-unqops-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
