    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-unqops-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-unqops-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
            <div className="text-xs text-unqops-elements-textSecondary">
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-unqops-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-unqops-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-unqops-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
